function [a_convcorr, t_convcorr] = conv_poly_corr(a1, t1, a2, t2, copula_discrete)
...
deltat = mean(diff(t1)); % Samples must be equally placed
...
for k = 1: K
    ...
    [a_tmp, t_tmp] = conv_poly(ax, t1, ay, t2);
    try
