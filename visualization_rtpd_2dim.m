...
csvwrite('table_fru_meanover_2dim.csv', tmp);
...
csvwrite('table_fru_maxover_2dim.csv', tmp);
...
csvwrite('table_fru_meanshort_2dim.csv', tmp);
...
csvwrite('table_fru_maxshort_2dim.csv', tmp);
...
csvwrite('table_frd_meanover_2dim.csv', tmp);
...
csvwrite('table_frd_maxover_2dim.csv', tmp);
...
csvwrite('table_frd_meanshort_2dim.csv', tmp);
...
csvwrite('table_frd_maxshort_2dim.csv', tmp);
